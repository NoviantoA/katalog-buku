...
import novianto.anggoro.spring.catalog.repository.PublisherRepository;
...
public class PublisherServiceImpl implements PublisherService {
    ...
    public Publisher findPublisher(String publisherId) {
        return publisherRepository.findBySecureId(publisherId).orElseThrow(() -> new BadRequestException("invalid publisher_id"));
    }
